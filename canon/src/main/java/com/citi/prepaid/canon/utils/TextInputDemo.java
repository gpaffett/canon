 ...
 */
public class TextInputDemo extends JPanel implements ActionListener,
    FocusListener
{
  ...
  protected JComponent createEntryFields()
  {
    ...
    String[] labelStrings = { "Street address: ", "City: ", "State: ",
        "Zip code: " };
    ...
    Spring2Utilities.makeCompactGrid(panel, labelStrings.length, 2, GAP, GAP,                                                                              // x,y
        GAP, GAP / 2);
    return panel;
  }
  ...
  {
    String[] stateStrings = { "Alabama (AL)", "Alaska (AK)", "Arizona (AZ)",
